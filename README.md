...
On an RTX 3090, this implementation can build a tree of 100K objects in 150us. Refitting takes 70us. Querying takes 60us. This makes it a fast solution for when performance is needed on the GPU.
